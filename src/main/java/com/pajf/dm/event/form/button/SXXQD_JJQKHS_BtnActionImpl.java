...
/**
 * @.description 综合客服-寿险新渠道-指令传输-解决情况后送按钮处理类
 * @version 1.0
 * @author wangz
 * @.update 2019年10月5日 下午3:33:13 
 */

public class SXXQD_JJQKHS_BtnActionImpl extends ValueListener {
